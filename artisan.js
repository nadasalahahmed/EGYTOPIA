...
function validateName() {
    ...
    if (nameRegex.test(name)) {
        ...
        nameValidation.textContent = 'Name must contain only letters, numbers, and spaces (2-50 characters)';
...
function validateEmail() {
    ...
    if (emailRegex.test(email)) {
        emailValidation.textContent = '✓ Email format is valid';
...
function validatePassword() {
    ...
    [lengthReq, letterReq, numberReq, specialReq].forEach(req => {
                    ...
                    ${wishlist.map(item => `
                        <div class="wishlist-item" data-id="${item.id}">
                            ...
                            <div class="wishlist-item-info">
                                ...
                                <p class="wishlist-item-rating">${item.ratingText || '★★★★★ (5)'}</p>
                            </div>
