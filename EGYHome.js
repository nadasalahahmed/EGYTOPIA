...
// Cart and wishlist will now be managed by window.cartManager
// Remove local cartItems and wishlistItems variables
...
function setupWishlistButtons() {
    ...
    productCards.forEach(card => {
        ...
        // Set initial heart state using shared manager
...
function updateWishlistButtonState(button, product) {
    const isInWishlist = window.cartManager.isInWishlist(product.id);
