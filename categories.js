// categories.js - ENFORCED LOGIN REQUIREMENT FOR CART/WISHLIST WITH AUTO-FILTERING
    ...
    if (filteredProducts.length === 0) {
        ...
        productsContainer.innerHTML = `
            <div class="no-products-message">
                ...
                <h3 style="color: #1a2f3a; margin-bottom: 10px;">No products found</h3>
                <p style="color: #666; max-width: 400px; margin: 0 auto;">
                    No products available in the "${getCategoryName(category)}" category at the moment.
...
console.log('Categories.js loaded successfully with STRICT LOGIN REQUIREMENT and AUTO-FILTERING!');
